...
// Generado el: PM.01.15 a las 06:35:41 PM CST 
//
 ...
 * 
 */
@XmlType(name = "c_Moneda", namespace = "http://www.sat.gob.mx/esquemas/ContabilidadE/1_3/CatalogosParaEsqContE")
@XmlEnum
public enum SatMoneda {
    ...
    public static SatMoneda fromValue(String v) {
        return valueOf(v)
    }
